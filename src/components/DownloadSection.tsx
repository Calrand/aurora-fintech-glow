      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4">
            Download <span className="gradient-text">Squirrelll</span> Today
          </h2>
          <p className="text-white/70 max-w-xl mx-auto text-sm md:text-base">
            Take the first step toward innovative micro-financing. Download Squirrelll now and start your journey to better micro-investments.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto glass-card p-6 md:p-8 lg:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">Get Squirrelll on Your Device</h3>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-6">
                  <Button className="bg-black hover:bg-black/80 text-white flex items-center gap-2 h-12 md:h-14" aria-label="Download on the App Store">
                  ...
                  <Button className="bg-black hover:bg-black/80 text-white flex items-center gap-2 h-12 md:h-14" aria-label="Get it on Google Play">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
        ...
        <div className="mt-8 md:mt-16 text-center">
          <p className="text-white/50 text-xs md:text-sm">By downloading, you agree to our <a href="#" className="underline hover:text-fintech-mint">Terms of Service</a> and <a href="#" className="underline hover:text-fintech-mint">Privacy Policy</a></p>
        </div>
      </div>
    </section>
  );
