...
const steps = [
  {
    ...
    description:
      'Get started by downloading the Squirrelll.ing app from Google Play (Android) or the App Store (iOS).',
  },
  {
    number: '02',
    title: 'Connect Your Payment Method',
    description:
      "Securely link your payment methods to start using Squirrelll.ing's features immediately.",
  },
  {
    number: '03',
    title: 'Start Squirrelll.ing',
    description:
      'Begin your journey to better investment management with our mobile app. Forget and grow effortlessly.',
  },
];
...
const HowItWorksSection: React.FC = () => {
  return (
    <section
      id="how-it-works"
      className="py-8 sm:py-10 md:py-12 lg:py-16 bg-fintech-darkBlue/50"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-12">
          ...
          <p className="text-white/70 max-w-xl mx-auto text-sm sm:text-base px-4">
            Getting started with Squirrelll.ing is simple. Follow these easy
        ...
        <div className="hidden lg:grid lg:grid-cols-3 gap-6 xl:gap-8 max-w-6xl mx-auto">
          {steps.map((step, index) => (
            <div
              key={index}
              className="glass-card p-6 xl:p-8 hover:shadow-lg transition-all hover:-translate-y-1"
            >
              <div className="flex flex-col items-center text-center">
                <div
                  className={`w-16 h-16 xl:w-20 xl:h-20 rounded-full ${
                    index === 0
                      ? 'bg-fintech-mint'
                      : index === 1
                        ? 'bg-fintech-amber'
                ...
                <div
                  className={`h-1 w-16 mt-6 xl:mt-8 ${
                    index === 0
                      ? 'bg-fintech-mint'
                      : index === 1
                        ? 'bg-fintech-amber'
