        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-fintech-mint to-fintech-amber hover:opacity-90 text-fintech-dark font-medium flex gap-2"
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-fintech-mint text-fintech-mint hover:bg-fintech-mint/10"
              >
                Learn More
              </Button>
            </div>
          ...
          <div className="flex-1 relative">
            ...
            <div className="absolute -top-6 -right-6 glass-card p-4 shadow-lg animate-float" style={{animationDelay: "1s"}}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-white/70">Payment Successful</p>
                  <p className="text-sm font-medium">$2,854.00</p>
                </div>
              </div>
            </div>
            
            <div className="absolute -bottom-4 -left-4 glass-card p-4 shadow-lg animate-float" style={{animationDelay: "2s"}}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-white/70">Investment Growth</p>
