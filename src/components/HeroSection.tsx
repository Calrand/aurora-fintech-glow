        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 md:gap-12 lg:gap-16 py-8 sm:py-12 md:py-16 lg:py-20">
          ...
          <div className="flex-1 relative mt-4 sm:mt-6 lg:mt-0 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-none mx-auto lg:mx-0 lg:flex lg:justify-center">
            <div className="glow-mint animate-float">
              <div className="relative z-10 glass-card p-1 sm:p-2 shadow-xl max-w-[280px] sm:max-w-[320px] md:max-w-[360px] lg:max-w-none mx-auto lg:w-[397.333px] lg:h-[257.5px] lg:p-2">
                <img
                  alt="Squirrelll.ing app interface"
                  className="rounded-lg w-full aspect-[1024/576] object-cover lg:w-[381.333px] lg:h-[241.5px] lg:aspect-auto"
